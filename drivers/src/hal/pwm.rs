...
impl PWMChannel {
    ...
    pub fn set_duty_cycle(&mut self, duty_cycle: f32) -> AeroResult<()> {
    ...
    pub fn set_pulse_width_us(&mut self, width_us: u32) -> AeroResult<()> {
        Self::set_pulse(self.channel, width_us)?;
        Ok(())
    }

    pub fn enable(&self) -> AeroResult<()> {
        Self::enable_channel(self.channel)?;
        Ok(())
    }

    pub fn disable(&self) -> AeroResult<()> {
    ...
    #[inline(always)]
    fn configure_frequency(channel: u8, freq: u32) -> AeroResult<()> {
        let _ = channel;
        let _ = freq;
        Ok(())
    }
    ...
    #[inline(always)]
    fn update_duty(channel: u8, duty: u16) -> AeroResult<()> {
        let _ = channel;
        let _ = duty;
        Ok(())
    }
    ...
    #[inline(always)]
    fn set_pulse(channel: u8, width_us: u32) -> AeroResult<()> {
        let _ = channel;
        let _ = width_us;
        Ok(())
    }
    ...
    #[inline(always)]
    fn enable_channel(channel: u8) -> AeroResult<()> {
        let _ = channel;
        Ok(())
    }

    #[inline(always)]
    fn disable_channel(channel: u8) -> AeroResult<()> {
        let _ = channel;
        Ok(())
    }
}
